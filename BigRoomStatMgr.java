...
public class BigRoomStatMgr
{
    ...
    // set ActiveSession数目
    public void setActiveSessionNum(int _ActiveSessionNum)
    {
        ActiveSessionNum = _ActiveSessionNum;
    }
    
    // add ActiveSession数目
    public void addActiveSessionNum(int _ActiveSessionNum)
    {
        ActiveSessionNum += _ActiveSessionNum;
    }
    ...
    public void printLog(String strFile)
	{
		...
		String str = String.format("=============================%s=============================\n" +
			...
			// ActiveSession数目
			"ActiveSessionNum\t%d\tActiveSession数目\n" +
