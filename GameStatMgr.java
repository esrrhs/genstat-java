...
public class GameStatMgr
{
    ...
    // Top收包数目
    private int[] TopRecvPacketNum = new int[100];
    
    // Top发包数目
    private int[] TopSendPacketNum = new int[100];
    
    // Top收包流量
    private int[] TopRecvSizeNum = new int[100];
    
    // Top发包流量
    private int[] TopSendSizeNum = new int[100];
    
    // Top收包处理时间
    private int[] TopProcessTime = new int[100];
    
    // Top所有的发包数目
    private int[] TopAllSendPacketNum = new int[200];
    
    // Top所有的发包流量
    private int[] TopAllSendSizeNum = new int[200];
